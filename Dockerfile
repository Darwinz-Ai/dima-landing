...
ENV NEXT_PUBLIC_POSTHOG_PROJECT_TOKEN="phc_zbDvpVAVZ6XzZTJCGKinnhPuLnrNnzRXj4zMNqLHTJxS"
ENV NEXT_PUBLIC_POSTHOG_HOST="https://n.thedar.ai"

# Receive build arguments from Cloud Build
ARG _FIREBASE_PROJECT_ID
ARG _FIREBASE_CLIENT_EMAIL
ARG _FIREBASE_PRIVATE_KEY

# Set environment variables for Next.js build
ENV FIREBASE_PROJECT_ID=$_FIREBASE_PROJECT_ID
ENV FIREBASE_CLIENT_EMAIL=$_FIREBASE_CLIENT_EMAIL
ENV FIREBASE_PRIVATE_KEY=$_FIREBASE_PRIVATE_KEY
# Copying all files
COPY . .
