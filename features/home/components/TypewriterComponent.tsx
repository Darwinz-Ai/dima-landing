...
const TypewriterComponent = () => {
    ...
    return (
        <div ref={container} className="flex-1 space-y-6 w-full">
            <h1 className="hero-element text-[24px] md:text-[44px] font-bold tracking-tight mb-8 min-h-32 md:min-h-[198px] lg:min-h-[264px] xl:min-h-[264px] 2xl:min-h-[198px]">
                ...
                <span ref={cursorRef} className="font-light text-primary ml-0.5">|</span>
            </h1>
