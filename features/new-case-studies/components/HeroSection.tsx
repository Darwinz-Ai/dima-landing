...
const HeroSection = async ({ caseStudy }: HeroSectionProps) => {
    ...
    return (
        <section className="w-full">
            <div className="w-full bg-[#351672] pb-16 px-6 relative overflow-hidden pt-26">
                ...
                <div className="container mx-auto relative z-10">
                    ...
                    <div className="flex justify-between items-center mb-12">
                        <div className="text-white text-4xl font-extrabold tracking-wide flex items-start">
                            dima
                        </div>
                        <div className="text-white/80 text-xs font-semibold tracking-[0.3em] uppercase">
                            {t("by")} THEDAR.AI
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 mb-8">
                        <span className="text-brand text-sm font-bold tracking-[0.3em] uppercase">
                            {caseStudy.type === "use cases" ? t("useCases") : t("customerSuccessStories")}
                        </span>
                        <Badge className="py-1.5 px-4 rounded-full border border-white/20 bg-white/5 text-white text-sm font-medium flex items-center gap-2 backdrop-blur-sm">
                    ...
                    {/* Headline */}
                    <h1 className="text-white text-[2rem] md:text-[2.50rem] font-bold leading-[1.2] mb-12 max-w-7xl">
                        {renderHeadline(
